...
function RegisterPage() {
  ...
  const [loading, setLoading] = useState(false); // ✅ On ajoute l'état de chargement
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(registerUser(finalFormData))
      .unwrap()
      .then(() => {
        // ✅ On utilise un toast de succès simple
        toast.success('Inscription réussie ! Vous pouvez maintenant vous connecter.');
        setTimeout(() => navigate('/login'), 2000);
      })
      .catch((error) => {
        // ✅ On utilise un toast d'erreur simple
        toast.error(error || "Une erreur est survenue.");
      })
      .finally(() => {
        // ✅ On s'assure de toujours désactiver le loader
        setLoading(false);
      });
  };
  ...
  return (
    <>
      ...
      <FullScreenLoader open={loading} message="Inscription en cours..." />
