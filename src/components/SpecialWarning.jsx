...
function SpecialWarning() {
  ...
  // ✅ 3. ON AJOUTE LA LOGIQUE MANQUANTE ICI
      ...
      >
        ...
        <Box>
            <Typography variant="caption" sx={{ fontStyle: 'italic', opacity: 0.8, fontSize: '1rem' }}>
              Cette notification restera visible jusqu'à ce que vous cliquiez sur "Fermer" ou que vous contactiez le support. Vous pouvez également envoyez une vérification de profil.
            </Typography>
        </Box>
